...
import qualityFindingFields from './quality-findings.yaml';
import qualityRunFields from './quality-runs.yaml';
import qualityRuleFields from './quality-rules.yaml';
...
processFields(qualityFindingFields);
processFields(qualityRunFields);
processFields(qualityRuleFields);
